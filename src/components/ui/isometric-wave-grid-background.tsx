...
const IsoLevelWarp = ({
    className,
    color = "57, 255, 20", // Neon green #39ff14
    speed = 1,
    density = 40,
    ...props
}: IsoLevelWarpProps) => {
    ...
    return (
        ...
        >
            ...
            {/* Vignette for depth */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#000_100%)] opacity-75 pointer-events-none" />
        </div>
    );
};
