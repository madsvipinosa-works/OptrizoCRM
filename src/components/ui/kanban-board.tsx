...
export const sampleData: Column[] = [
  {
    id: 'todo',
    title: 'To Do',
    color: '#8B7355',
    tasks: [
      {
        ...
        priority: 'high',
        assignee: { name: 'Sarah Chen', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80' },
        tags: ['Design', 'System'],
        dueDate: '2024-01-15',
        attachments: 3,
        comments: 7,
      },
      {
        ...
        priority: 'medium',
        assignee: { name: 'Alex Rivera', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80' },
        tags: ['Research', 'UX'],
        dueDate: '2024-01-18',
        comments: 4,
      },
    ...
    tasks: [
      {
        ...
        priority: 'high',
        assignee: { name: 'Jordan Kim', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80' },
        tags: ['Mobile', 'UI'],
        attachments: 8,
        comments: 12,
      },
    ...
    tasks: [
      {
        ...
        priority: 'medium',
        assignee: { name: 'Maya Patel', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80' },
    ...
    tasks: [
      {
        ...
        priority: 'low',
        assignee: { name: 'Chris Wong', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&auto=format&fit=crop&q=80' },
        tags: ['Marketing', 'Web'],
        attachments: 2,
        comments: 8,
      },
