...
export function UserNav({ user, isAdmin, onSignOut, isPending }: UserNavProps) {
    ...
    return (
        ...
        >
            ...
            <DropdownMenuContent
                className="w-56 bg-zinc-950 border-zinc-800 text-zinc-200 shadow-2xl p-1.5 rounded-xl z-50"
                align="end"
                sideOffset={8}
            >
                ...
                <DropdownMenuGroup>
                    <DropdownMenuItem asChild className="focus:bg-zinc-900 focus:text-white rounded-lg cursor-pointer text-xs py-2 px-2.5 font-medium">
